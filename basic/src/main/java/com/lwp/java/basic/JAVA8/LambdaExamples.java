...
public class LambdaExamples {
    ...
    public static void main(String[] args) {
        ...
        //-----case 5----------
        //one parameter becomes target and basic.other becomes argument
    ...
    class EvenSelector implements Selector{
        ...
        @Override
        public boolean pick(int value) {
            return value %2==0; //this is the essence of this class rest basic.other code is ceremony so in lambda we only focus on essence.
        }
